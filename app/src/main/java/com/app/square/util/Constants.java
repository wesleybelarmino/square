...
public class Constants {
    ...
    public static final String BASE_YOUTUBE_URL_IMAGE = "https://img.youtube.com/vi/";
    public static final String MOVIE_SAVED_INSTANCE = "movie";
    public static final String MOVIES_SORT_BY_MOST_POPULAR = "popularity.desc";
    public static final String MOVIES_SORT_BY_BEST_RATING = "top_rated.desc";
    public static final String MOVIES_SORT_BY_FAVORITES = "favorites";
